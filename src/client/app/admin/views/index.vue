...
<div class="mk-admin" :class="{ isMobile }">
	...
	<nav v-show="navOpend" @click="navOpend = !isMobile">
		...
		<ul>
			<li><router-link to="/dashboard" active-class="active"><i class="fas fa-home fa-fw"></i>{{ $t('dashboard') }}</router-link></li>
			<li><router-link to="/instance" active-class="active" v-if="$store.getters.isAdminOrModerator"><i class="fas fa-cog fa-fw"></i>{{ $t('instance') }}</router-link></li>
			...
			<li><router-link to="/users" active-class="active" v-if="$store.getters.isAdminOrModerator"><i class="fas fa-users fa-fw"></i>{{ $t('users') }}</router-link></li>
			<li><router-link to="/drive" active-class="active" v-if="$store.getters.isAdminOrModerator"><i class="fas fa-cloud fa-fw"></i>{{ $t('@.drive') }}</router-link></li>
			...
			<li><router-link to="/announcements" active-class="active" v-if="$store.getters.isAdminOrModerator"><i class="fas fa-broadcast-tower fa-fw"></i>{{ $t('announcements') }}</router-link></li>
			<li><router-link to="/hashtags" active-class="active" v-if="$store.getters.isAdminOrModerator"><i class="fas fa-hashtag fa-fw"></i>{{ $t('hashtags') }}</router-link></li>
