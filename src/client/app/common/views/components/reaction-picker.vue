...
<div class="rdfaahpb" v-hotkey.global="keymap">
	...
	<div class="popover" :class="{ isMobile: $root.isMobile }" ref="popover">
		...
		<div class="text">
			...
			<button :title="$t('pick')" class="emoji" @click="emoji" ref="emoji"><i class="far fa-laugh"></i></button>
			<button :title="$t('random')" @click="reactRandom()"><i class="far fa-random"></i></button>
