...
<div class="xqnhankfuuilcwvhgsopeqncafzsquya">
	...
	<header><b><router-link :to="blackUser | userPage"><mk-user-name :user="blackUser"/></router-link></b><span> <i class="fas fa-Circle"></i></span> vs <b><router-link :to="whiteUser | userPage"><mk-user-name :user="whiteUser"/></router-link></b><span> <i class="far fa-circle"></i></span></header>
	...
	<p class="status"><b>{{ $t('@.reversi.this-turn', { count: logPos }) }}</b><fa :icon="fasCircle" style="margin-left: 0.5em"/>:{{ o.blackCount }} <i class="far fa-circle"></i>:{{ o.whiteCount }} {{ $t('@.reversi.total') }}:{{ o.blackCount + o.whiteCount }}</p>
