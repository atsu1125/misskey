	...
	<transition name="nav">
		<div class="body" :class="{ notifications: showNotifications }" v-if="isOpen">
			...
			<div class="notifications" v-if="showNotifications">
				<header>
					<button @click="showNotifications = false"><i class="fas fa-times"></i></button>
					<i v-if="hasUnreadNotification" class="circle"><i class="fas fa-circle"></i></i>
				</header>
...
export default Vue.extend({
	...
	data() {
		return {
			...
			faNewspaper, faUsers, faMoon, faSun, faHome, faColumns, faSync, faDesktop, faMobileAlt, faStickyNote, faThumbsUp
		};
	},
